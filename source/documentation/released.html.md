...
|**[Enhanced HATEOAS complience](https://developer.service.hmrc.gov.uk/api-documentation/docs/api/service/common-transit-convention-traders/1.0)**| Add new fields and an element ID to response bodies for all endpoints to provide more flexibility|
